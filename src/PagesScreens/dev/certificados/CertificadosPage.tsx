...
export const CertificadosPage = () => {
    return (
        <div className="certificadosPageStyle">
            <h2>Certificados</h2>
            <p id="certificados">Descubre la variedad de cursos tomados a lo largo de mi desarrollo personal y profesional.</p>
            <div className="certificadosYCursos">
                <div className="container">
                    <ContenidoDesplegable title="Certificados oficiales">
                        <div className="imagenes">
                            <a href="/certificados/profesional/11.jpg" target="_blank" className="certificado">
                ...
                <div className="container">
                    <ContenidoDesplegable title="Habilidades Blandas">
                        <div className="imagenes">
                            ...
                            <a href="/certificados/profesional/6.jpg" target="_blank" className="certificado">
                ...
                <div className="container">
                    <ContenidoDesplegable title="Idiomas">
                        <div className="imagenes">
                            <a href="/certificados/idioma/1.jpg" target="_blank" className="certificado">
                            ...
                            <a href="/certificados/idioma/2.jpg" target="_blank" className="certificado">
                ...
                <div className="container">
                    <ContenidoDesplegable title="Reconocimientos">
                        <div className="imagenes">
                            <a href="/certificados/profesional/12.jpg" target="_blank" className="certificado">
