    ...
    return (
        <div className="perfilDescripcion" id="perfil">
            ...
            <p>
                ...
                <b>páginas web</b>, <b>aplicaciones web</b> y <b>componentes</b>{" "}
                especializados.
            </p>
            <p>
                He trabajado frente a frente con empresas como <b>Softtek</b>,{" "}
                <b>Walmart</b>, <b>Areoméxico</b>, <b>BBVA</b> y <b>Betterware</b>,
                además de haber realiado trabajos pequeños para clientes
            ...
            <p>
                ...
                contínuo como <b>Scrum, Agile y Kanban</b>.
            </p>
            <p>
                Me considero autodeterminado, autodidacta, detallista, flexible,
                resiliente, líder, empático, resolutivo, enfocado a las metas y a
                aportar valor a las personas.
            </p>
            <p>
                Siempre busco tener mi stack tecnológico actualizado, y junto con un
                conjunto amplio de habilidades blandas, lograr trabajar en armonía y
                lograr el éxito de nuestros objetivos.
            </p>
        </div>
    )
}