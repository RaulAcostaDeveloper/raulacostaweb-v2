...
export const CvPage = () => {
    return (
        <div className="curriculumPageStyle">
            ...
            <p id="curriculum">Hecha un vistazo a mi currículum para saber más de mi trayectoria profesional.</p>
            <div className="contenedorCurriculums">
                <a href="/images/cvs/1.jpg" target="_blank" className="curriculum" title="Ver mi CV">
                    <Image src={'/images/cvs/1.jpg'} alt="cv en español" width={150} height={200} />
