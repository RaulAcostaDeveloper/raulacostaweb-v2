    ...
    <main>
      <section>
        ...
        <ContenidoDesplegable title="Mis poemas">
          ...
          <ContenidoDesplegable title="A tí y a mí">
            <i>
              <p>Templa mi cuerpo en tu llama</p>
              <p>Dame nueva forma hacia el bien</p>
              <p>Tú tienes poder</p>
              <p>Manténme a salvo del fuego y del dolor,</p>
              <p>porque con ese salvo doy gracias al señor</p>
              <p>Más haz el bien, y deja lo otro atrás,</p>
              <p>olvídalo en silencio...</p>
              <p>Ten piedad de ti mismo,</p>
          ...
          <ContenidoDesplegable
            title="Estar el camino correcto"
            colapse={false}
          >
            <i>
          ...
          <ContenidoDesplegable title="Una flor de mi jardín" colapse={false}>
            <i>
              ...
              <p>Más otra etapa y nuevo ciclo</p>
              <p>Para mi jardín florecer</p>
            </i>
          </ContenidoDesplegable>
      ...
      <section>
        <ContenidoDesplegable title="Mis escritos" colapse={false}>
          <ContenidoDesplegable
            title="Escritos no clasificados"
            colapse={false}
          >
            ...
            <p>
              ...
              nuevo, eres mi plano en todas partes. Ponme en camino de lo bueno
              en mí, y fortalece mis lazos contigo, lazos del bien.
            </p>
            <p>
              Dale tranquilidad a mi corazón. Pon mi ser en suave y rica
              estancia. Dame dulce y plena compañía buena, que me de
              complacencia y me haga saber verdad que por mí no sepa.
            </p>
            <p>
              Alivia mi culpa, hazme pagar con buenas acciones, perdoname si he
              hecho mal, hazme hacer el bien a cambio, hazme ser el bien del
              mundo, aliviana mi sentir, hazme sentir gozo y alegría, y sobre
              todo, hazme ser merecedor, si no lo fuera ya.
            </p>
            <p>
            ...
            <p>
              Hazme limpio, hazme bueno, dame palabras correctas, haz tu
              justicia en mí, atrae a mí toda muestra de afecto, recibe de mí lo
              justo y lo bueno.
            </p>
            <p>
